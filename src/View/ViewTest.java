...
public class ViewTest {
    ...
    @Test
    public void testSetPreviousStack() throws Exception {
        String[] test = {"test"};
    ...
    @Test
    public void testSetPreviousQueue() throws Exception {
        String[] test = {"test"};
    ...
    @Test
    public void testSetPreviousStackJava() throws Exception {
        String[] test = {"test"};
    ...
    @Test
    public void testSetPreviousQueueJava() throws Exception {
        String[] test = {"test"};
